...
export default function DropZone({ onFile }: Props) {
  ...
  return (
    <div
      ...
      className={[
        "w-full border-2 border-dashed rounded-xl p-12 flex flex-col items-center gap-4 cursor-pointer transition-all",
        dragging
    ...
    >
      <div className="w-14 h-14 rounded-2xl bg-neutral-800 flex items-center justify-center">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7 text-neutral-400">
